...
module.exports = {
  ...
  clientId: 'ddb6d7cb-c8e3-4099-a37f-97d48708b64b',
  obfuscatedClientSecret: 'GDa8Q~tVy4_A6kldOqTWboegqShc0Ah0M12UlboSU2FsdGVkX19Agj087aMpGG8VemkCsvGVVIn0z/+WPTYficTqJuZ4tZAHSfTIHD8bPSGWi9tGIyGYTgPEoObmRQ==',

  // The redirectUri is the URL that the user will be redirected to after they have authenticated with Microsoft Graph API.
  // Likewise, you would not need to change redirectUri if you are using your personal Microsoft account with OneDrive International.
  redirectUri: 'https://one-drive-mu.vercel.app/',
